...
public class Signinstudent extends Activity {
	...
	public class QuerySQL extends AsyncTask<String, Void, Boolean> {
		...
		protected void onPreExecute() {
			...
			pDialog = new ProgressDialog(Signinstudent.this);
		...
		protected void onPostExecute(Boolean result1) {
			...
			if (result1) {
				...
				try {// try3 open
					...
					Intent intent = new Intent(Signinstudent.this,
							ViewStudentlist2atten.class);
